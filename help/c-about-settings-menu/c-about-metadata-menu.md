...
1. Stel op de pagina [!DNL Add Field] de gewenste opties in.
   ...
   <table> 
    ...
    <ul id="ul_945844C33C2E4D95A598C4876E15F211"> 
      ...
      <li id="li_AECA6880002F40FAB1820B37237550A7">als de waarde groter dan of gelijk aan (&gt;=) de grootste waarde in <span class="uicontrol"> de Waarden van de Waaier </span> is, zal <span class="uicontrol"> "Groter dan"Formaat </span> worden gebruikt </li> 
